      ...
      >
        ...
        >
          <div>
            <img
              src={img}
              alt=""
              className="max-w-full w-full h-auto rounded-2xl"
            />
          </div>
        </div>
        <div className="col-span-12 lg:col-span-7">
          <div className="mt-6 lg:mt-0 lg:px-12 text-center lg:text-start h-full flex flex-col justify-center">
            ...
            <div>
              <button onClick={() => navigate("/contact")} className="font-bold bg-blue-600 text-white px-5 py-2 hover:bg-opacity-90 duration-300 rounded inline-flex">
                I Am Interested
              </button>
            </div>
          </div>
    ...
    <div className="z-30">
      ...
      <div className=" py-3 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-[10px] md:text-lg md:mx-36 font-normal text-gray-500 mb-2">
            Your relationship with Goal International Public School doesn't end
            once you graduate. You can stay involved by giving back in a variety
            of ways.
          </h2>
        </div>
      </div>
      ...
      <section className="ezy__portfolio16 light py-14 md:py-12 text-zinc-900 ">
        <div className="container px-4 mx-auto">
          <div className="flex justify-between items-center max-w-7xl mx-auto"></div>
